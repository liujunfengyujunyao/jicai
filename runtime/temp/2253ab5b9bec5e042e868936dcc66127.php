<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/data/www/jicai.sxxd365.com/public/../application/admin/view/supplier/supplier/add.html";i:1626686971;s:70:"/data/www/jicai.sxxd365.com/application/admin/view/layout/default.html";i:1626686927;s:67:"/data/www/jicai.sxxd365.com/application/admin/view/common/meta.html";i:1626686926;s:69:"/data/www/jicai.sxxd365.com/application/admin/view/common/script.html";i:1626686926;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">是否允许登录:</label>
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
                ...
                <label for="row[is_login]-<?php echo $key; ?>"><input id="row[is_login]-<?php echo $key; ?>" name="row[is_login]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"0"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <span style="color: #18bc9c;font-size:12px">若开启则使用联系电话登录，默认密码为123456的用户可自行登录修改</span>
            </div>
