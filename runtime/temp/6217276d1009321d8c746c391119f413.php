<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/data/www/jicai.sxxd365.com/public/../application/admin/view/order/order/next2.html";i:1626686969;s:70:"/data/www/jicai.sxxd365.com/application/admin/view/layout/default.html";i:1626686927;s:67:"/data/www/jicai.sxxd365.com/application/admin/view/common/meta.html";i:1626686926;s:69:"/data/www/jicai.sxxd365.com/application/admin/view/common/script.html";i:1626686926;}*/ ?>
<!DOCTYPE html>
...
<!--                                <input id="update_status" type="text" class="form-control" value="<?php echo $update_status; ?>" readonly>-->
                            </div>
                        </div>
                        <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            <label for="department.name" class="control-label col-xs-4">
                            ...
                            <div class="col-xs-8">
                                <input id="address" type="text" class="form-control" value="<?php echo $address; ?>" readonly>
                                <!--                                <input id="update_status" type="text" class="form-control" value="<?php echo $update_status; ?>" readonly>-->
                            </div>
                        </div>
                    </div>
