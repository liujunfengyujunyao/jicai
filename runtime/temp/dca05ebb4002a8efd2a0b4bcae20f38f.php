    ...
    <div class="form-group" style="display:none">
        ...
        <div class="col-xs-8 col-sm-8">
            <input id="department_id"
                   class="form-control" name="row[department_id]" type="text" value="<?php echo $department_id; ?>" autocomplete="off">
        </div>
    </div>
