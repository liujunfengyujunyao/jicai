define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'goodscenter/webchuangjiawang/index' + location.search,
                    add_url: 'goodscenter/webchuangjiawang/add',
                    edit_url: 'goodscenter/webchuangjiawang/edit',
                    del_url: 'goodscenter/webchuangjiawang/del',
                    multi_url: 'goodscenter/webchuangjiawang/multi',
                    table: 'webchuangjiawang',
                }
            });
