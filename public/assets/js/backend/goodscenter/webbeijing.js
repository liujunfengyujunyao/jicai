define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'goodscenter/webbeijing/index' + location.search,
                    add_url: 'goodscenter/webbeijing/add',
                    edit_url: 'goodscenter/webbeijing/edit',
                    del_url: 'goodscenter/webbeijing/del',
                    multi_url: 'goodscenter/webbeijing/multi',
                    table: 'webbeijing',
                }
            });
