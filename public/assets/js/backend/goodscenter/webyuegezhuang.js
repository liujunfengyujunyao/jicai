define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'goodscenter/webyuegezhuang/index' + location.search,
                    add_url: 'goodscenter/webyuegezhuang/add',
                    edit_url: 'goodscenter/webyuegezhuang/edit',
                    del_url: 'goodscenter/webyuegezhuang/del',
                    multi_url: 'goodscenter/webyuegezhuang/multi',
                    table: 'webyuegezhuang',
                }
            });
